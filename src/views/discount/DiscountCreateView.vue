...
const fetchData = async () => {
  try {
    ...
    subcategories.value = subcategoriesResponse.data.data.data;
    items.value = itemsResponse.data.data.data;
  } catch (e) {
...
const addDiscount = async () => {
  try {
    loading.value = true;
    await api.post("/discount/store", {
      value: discountValue.value,
      discountable_id: discountable_id.value,
...
<template>
  <div class="card">
    <div class="card-body d-flex justify-content-between">
      ...
      <router-link to="/discount" class="btn btn-dark">Back</router-link>
    </div>
    <div class="card-body">
